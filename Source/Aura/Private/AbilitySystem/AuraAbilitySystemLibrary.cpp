...
#include "Engine/OverlapResult.h" // UE 5.7
...
{
	if (FAuraGameplayEffectContext* AuraEffecContext = static_cast<FAuraGameplayEffectContext*>(EffectContextHandle.Get()))
	{
		AuraEffecContext->SetIsBlockedHit(bInIsBlockedHit);
	}
}
	...
	bool bInIsCriticalHit)
{
	if (FAuraGameplayEffectContext* AuraEffecContext = static_cast<FAuraGameplayEffectContext*>(EffectContextHandle.Get()))
	{
		AuraEffecContext->SetIsCriticalHit(bInIsCriticalHit);
	}
}
